package com.borhan.commands.metadataBatch
{
	...
	import com.borhan.delegates.metadataBatch.MetadataBatchGetExclusiveConvertJobsDelegate;
	import com.borhan.net.BorhanCall;

	public class MetadataBatchGetExclusiveConvertJobs extends BorhanCall
	{
		public var filterFields : String;
		public function MetadataBatchGetExclusiveConvertJobs( lockKey : BorhanExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : BorhanBatchJobFilter=null )
		{

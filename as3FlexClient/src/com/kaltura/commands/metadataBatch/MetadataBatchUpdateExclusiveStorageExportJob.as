package com.borhan.commands.metadataBatch
{
	...
	import com.borhan.delegates.metadataBatch.MetadataBatchUpdateExclusiveStorageExportJobDelegate;
	import com.borhan.net.BorhanCall;

	public class MetadataBatchUpdateExclusiveStorageExportJob extends BorhanCall
	{
		public var filterFields : String;
		public function MetadataBatchUpdateExclusiveStorageExportJob( id : int,lockKey : BorhanExclusiveLockKey,job : BorhanBatchJob,entryStatus : int=undefined )
		{

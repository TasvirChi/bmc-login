package com.borhan.commands.metadataBatch
{
	...
	import com.borhan.delegates.metadataBatch.MetadataBatchGetExclusiveAlmostDoneBulkDownloadJobsDelegate;
	import com.borhan.net.BorhanCall;

	public class MetadataBatchGetExclusiveAlmostDoneBulkDownloadJobs extends BorhanCall
	{
		public var filterFields : String;
		public function MetadataBatchGetExclusiveAlmostDoneBulkDownloadJobs( lockKey : BorhanExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : BorhanBatchJobFilter=null )
		{

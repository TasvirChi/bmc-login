package com.borhan.commands.metadataBatch
{
	...
	import com.borhan.delegates.metadataBatch.MetadataBatchGetExclusiveStorageExportJobsDelegate;
	import com.borhan.net.BorhanCall;

	public class MetadataBatchGetExclusiveStorageExportJobs extends BorhanCall
	{
		public var filterFields : String;
		public function MetadataBatchGetExclusiveStorageExportJobs( lockKey : BorhanExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : BorhanBatchJobFilter=null )
		{

package com.borhan.commands.metadataBatch
{
	...
	import com.borhan.delegates.metadataBatch.MetadataBatchUpdateExclusiveImportJobDelegate;
	import com.borhan.net.BorhanCall;

	public class MetadataBatchUpdateExclusiveImportJob extends BorhanCall
	{
		public var filterFields : String;
		public function MetadataBatchUpdateExclusiveImportJob( id : int,lockKey : BorhanExclusiveLockKey,job : BorhanBatchJob,entryStatus : int=undefined )
		{

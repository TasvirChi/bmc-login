package com.borhan.analytics
{
	...
	public class GoogleAnalyticsTracker
	{
		...
		private var _bmcVersion:String;
        ...
        public function init(partnerId:String, userId:String, parentDisplayObject:DisplayObject,bmcVersion:String,urchinNumber:String, langCode:String, debug:Boolean):void
        {
        	_bmcVersion=bmcVersion;
        ...
        {
			if (_urchinNumber) {
        		tracker.trackPageview(_bmcVersion+"/"+ eventTracked+"/"+"partner_id=" + _partnerId + "/user_id=" + _userId );
			}
        }
	}
}
